...
{
    private static final String TAG = "Beerbreweryandroid";
    private static final String SERVER_URL = "http://api.brewerydb.com/v2/?key=485d537596b0197fe767a7ed5dc562fe";
